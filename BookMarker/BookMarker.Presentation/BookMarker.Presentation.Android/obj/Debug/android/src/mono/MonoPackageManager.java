...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "BookMarker.Presentation.Android.dll" comes first in this list. */
		"BookMarker.Presentation.Android.dll",
		"BookMarker.Presentation.dll",
		"FormsViewGroup.dll",
